...
var _ = (e, o, t) => rt(e, typeof o != "symbol" ? o + "" : o, t), x = (e, o, t) => o.has(e) || G("Cannot " + t);
...
import { R as nt } from "./client-DeHBg55h.js";
...
var k, M, w, L, N, A, b, S, E, C, u, T, X, Z, V, tt;
const R = class R extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
    d(this, u);
    _(this, "loadComplete", new J());
    d(this, k);
    d(this, M);
    d(this, w, !1);
    d(this, L, 0);
    ...
    d(this, C, (t) => {
      ...
      if (i?.["x-tiktok-player"])
        switch (i.type) {
          ...
          case "onCurrentTime":
            a(this, L, i.value.currentTime), a(this, S, i.value.duration), this.dispatchEvent(new Event("durationchange")), this.dispatchEvent(new Event("timeupdate"));
            break;
          case "onVolumeChange":
  ...
  async load() {
    if (l(this, k)) return;
    this.shadowRoot || this.attachShadow(R.shadowRootOptions);
    const t = !l(this, M);
    if (l(this, M) && (this.loadComplete = new J()), a(this, M, !0), await a(this, k, Promise.resolve()), a(this, k, null), a(this, L, 0), a(this, w, !1), a(this, N, !0), !this.src) {
      this.shadowRoot.innerHTML = "", globalThis.removeEventListener("message", l(this, C));
      return;
    }
    let s = this.shadowRoot.querySelector("iframe");
    const i = ct(this.attributes);
    t && s && a(this, A, JSON.parse(s.getAttribute("data-config") || "{}")), (!s?.src || s.src !== Q(i, this)) && (this.shadowRoot.innerHTML = z(i, this), s = this.shadowRoot.querySelector("iframe")), a(this, E, s), globalThis.addEventListener("message", l(this, C));
  }
...
k = new WeakMap(), M = new WeakMap(), w = new WeakMap(), L = new WeakMap(), N = new WeakMap(), A = new WeakMap(), b = new WeakMap(), S = new WeakMap(), E = new WeakMap(), C = new WeakMap(), u = new WeakSet(), T = function(t, s) {
  var i;
...
}, _(R, "getTemplateHTML", z), _(R, "shadowRootOptions", { mode: "open" });
let H = R;
...
function gt({
  ...
  const U = Number.parseInt(e.version) >= 19, W = e.forwardRef(($, P) => {
    var j, B;
    const m = e.useRef(null), D = e.useRef(/* @__PURE__ */ new Map()), O = {}, q = {}, p = {}, I = {};
    ...
    if (typeof window < "u") {
      for (const r in O) {
        const n = O[r], c = r.endsWith("Capture"), v = (s?.[r] ?? r.slice(2).toLowerCase()).slice(
          0,
          c ? -7 : void 0
        );
        e.useLayoutEffect(() => {
      ...
      e.useLayoutEffect(() => {
        ...
        for (const n in I)
          K(m.current, n, I[n]), D.current.delete(n), r.set(n, I[n]);
