...
const headingItemVariants = cva(
	"block h-auto w-full cursor-pointer truncate px-0.5 py-1.5 text-left font-medium text-muted-foreground underline decoration-[0.5px] underline-offset-4 hover:bg-accent hover:text-muted-foreground [border-radius:var(--editor-chip-radius)]",
	{
		variants: {
			depth: {
				1: "pl-0.5",
