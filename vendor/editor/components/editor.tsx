		...
		variants: {
			variant: {
				comment: cn(
					...
					"editor-frame border-transparent bg-transparent",
				...
				demo: "h-[650px]",
				select: cn(
					"group editor-frame border-input ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2",
	...
	),
	{
		...
		variants: {
			...
			variant: {
				...
				comment: cn("bg-transparent text-sm [border-radius:var(--editor-frame-radius)] border-none"),
				default:
