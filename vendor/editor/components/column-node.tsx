				...
				>
					<div
						className={cn(
							...
							!readOnly &&
								"border-border border-dashed [border-radius:var(--editor-frame-radius)] [box-shadow:var(--editor-frame-shadow)]",
	...
	return (
		<PlateElement className="mb-2" {...props}>
			<ColumnFloatingToolbar>
				<div className="flex size-full [border-radius:var(--editor-frame-radius)]">
					{props.children}
				</div>
			</ColumnFloatingToolbar>
		</PlateElement>
