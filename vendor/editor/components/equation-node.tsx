		...
		<PlateElement className="my-1" {...props}>
			<Popover open={open} onOpenChange={setOpen} modal={false}>
				<PopoverTrigger asChild>
					<div
						className={cn(
							"group flex cursor-pointer select-none items-center justify-center [border-radius:var(--editor-inline-code-radius)] hover:bg-primary/10 data-[selected=true]:bg-primary/10",
...
export function InlineEquationElement(
	...
	return (
			...
			{...props}
			className={cn(
				"mx-1 inline-block select-none [border-radius:var(--editor-inline-code-radius)] [&_.katex-display]:my-0!",
			)}
		>
			<Popover open={open} onOpenChange={setOpen} modal={false}>
				<PopoverTrigger asChild>
