...
import { Popover, PopoverContent } from "@bunship-ai/ui/components/popover";
...
function TableFloatingToolbar({
	...
	return (
		...
		>
			...
			>
				<Toolbar
					className="editor-toolbar-surface scrollbar-hide flex w-auto max-w-[80vw] flex-row overflow-x-auto bg-popover p-1 print:hidden"
					contentEditable={false}
				>
					<ToolbarGroup>
